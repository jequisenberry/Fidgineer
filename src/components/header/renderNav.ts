...
function addEventListenerToItem(
...
function dropdownLogic(
        targetChildElement: HTMLElement,
        active: boolean | 'click'
    ): void {

        const classState: boolean =
            targetChildElement.classList.contains("menu-dropdown-open");

        if (active === 'click') active = !classState;
